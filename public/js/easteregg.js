import { isOpenHelp } from "./script.js"
    ...
    document.body.addEventListener("keydown", (event) => {
        ...
        for(let i = 0; i < length; i++) {
            ...
            if(i === konamiCode.length - 1) {
                ...
                videoAngle = transform
                video.style.transform = `rotate(${videoAngle}deg)`
                video.style.transition = "0"
                document.getElementById("seek").style.transform = `rotate(${videoAngle}deg)`
            }
        }
    })
}
